    ...
    return(
        <footer>
            ...
            <div className="footer">
                ...
                <div className="footer__network">
                    <img src={linkedin} alt="linkedin logo" /><a rel="noreferrer" target='_blank' href="https://www.linkedin.com/in/ignacio-emiliano-juarez/">linkedin.com/in/ignacio-emiliano-juarez/</a>
                </div>
                <div className="footer__network">
